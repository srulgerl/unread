...
.head-container .content .title .category {
  line-height: normal;
  margin-top: 7px;
}
.head-container .content .title .real-title {
  flex-wrap: wrap;
  line-height: normal;
  font-size: 17px;
  font-weight: bold;
...
.container-center .author .prof {
  display: flex;
  flex-direction: column;
  margin-right: 44px;
}
.container-center .author .prof a {
  text-decoration: none;
  color: black;
  font-size: 0.8rem;
}
.container-center .author .prof p {
  color: #888888;
  font-size: 0.8rem;
}
...
.container-article .article1:nth-child(even) .author .prof {
  margin-right: 15px;
  text-align: right;
}
